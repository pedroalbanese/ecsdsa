...
var (
	ErrParametersNotSetUp = errors.New("ecsdsa: parameters not set up before generating key")
	ErrInvalidASN1        = errors.New("ecsdsa: invalid ASN.1")
	ErrInvalidSignerOpts  = errors.New("ecsdsa: opts must be *SignerOpts")
)
